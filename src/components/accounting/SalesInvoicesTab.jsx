      ...
      >
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div>
            ...
            <input
              ...
              className="mt-1.5 block w-full rounded-lg border border-slate-600 bg-slate-700 px-3 py-2 text-sm text-slate-100 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-300">
        ...
        <div className="mt-4 space-y-2">
          ...
          {lines.map((line, index) => (
            <div key={index} className="flex flex-wrap items-center gap-2">
              <select
                ...
                className="min-w-[10rem] flex-1 rounded-lg border border-slate-600 bg-slate-700 px-3 py-2 text-sm text-slate-100 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              >
              ...
              <input
                ...
                className="w-24 rounded-lg border border-slate-600 bg-slate-700 px-3 py-2 text-sm text-slate-100 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              />
              {line.itemId && (
              ...
              <input
                ...
                className="w-28 rounded-lg border border-slate-600 bg-slate-700 px-3 py-2 text-sm text-slate-100 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              />
              {lines.length > 1 && (
                <button
                  type="button"
          ...
          <button
            type="button"
            onClick={addLine}
            className="flex items-center gap-1.5 text-xs font-medium text-primary-400 hover:text-primary-300"
          >
        ...
        <div className="mt-4 space-y-2 rounded-lg bg-slate-700/50 p-4">
          ...
          <div className="flex justify-between text-sm font-medium text-slate-100 border-t border-slate-600 pt-2">
