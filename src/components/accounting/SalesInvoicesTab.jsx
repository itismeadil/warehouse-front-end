...
export default function SalesInvoicesTab() {
  ...
  return (
    <div>
      ...
      {/* Helpful Hint */}
      <div className="mb-4 rounded-lg bg-purple-50 px-4 py-3 border border-purple-200 dark:border-purple-800 dark:bg-purple-900/30">
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0">
            <Plus className="h-5 w-5 text-purple-600" />
          </div>
          <div className="flex-1">
            <h4 className="text-sm font-semibold text-purple-900 mb-1 dark:text-purple-300">
              {t("salesInvoicesHintTitle")}
            </h4>
            <p className="text-xs text-purple-800 leading-relaxed dark:text-purple-300">
              {t("salesInvoicesHint")}
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="mt-4 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 text-sm text-primary-600 hover:text-primary-700 disabled:opacity-50 dark:text-primary-400 dark:hover:text-primary-300"
            >
              <RefreshCw
        ...
        <div className="mt-4 space-y-2 rounded-lg bg-graphite-50 p-4 dark:bg-graphite-800">
          ...
          <div className="flex justify-between border-t border-graphite-200 pt-2 text-sm font-medium text-graphite-900 dark:border-graphite-700 dark:text-graphite-100">
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <label className="text-sm text-graphite-600 dark:text-graphite-400">
              {t("filterByDate")}
            </label>
            <DatePicker
              value={selectedDate}
            ...
            {selectedDate && (
              <button
                ...
                className="rounded-lg px-2 py-1.5 text-xs font-medium text-primary-600 hover:bg-primary-50 hover:text-primary-700 transition-colors dark:text-primary-400 dark:hover:bg-primary-900/30 dark:hover:text-primary-300"
              >
                {t("clear")}
              </button>
            )}
              ...
              {filteredInvoices.map((inv) => (
                <div key={inv._id} className="px-4 py-3">
                  ...
                  {(inv.vatAmount !== undefined ||
                    ...
                    <div className="mt-2 flex items-center gap-3 text-xs text-graphite-600 dark:text-graphite-400">
                      {inv.vatRate !== undefined && (
                        <span>
                          {t("vat")}: {inv.vatRate}%
                        </span>
